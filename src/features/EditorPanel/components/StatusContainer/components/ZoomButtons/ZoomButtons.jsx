...
function ZoomButtons() {
    const { cameraState, documentViewRef } = useContext(DocumentContext);

    const syncDocumentView = () => {
        documentViewRef.current.style.display = "none";
        documentViewRef.current.offsetHeight;
        documentViewRef.current.style.display = "";
    };
