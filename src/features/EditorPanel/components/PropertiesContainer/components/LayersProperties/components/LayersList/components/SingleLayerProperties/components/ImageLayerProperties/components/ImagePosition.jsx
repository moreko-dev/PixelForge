...
function ImagePosition({ layerID }) {
    ...
    const alignButtonsHandler = (align) => {
        ...
        const canvasObj = projectState.canvas;
        ...
        if (align.endsWith("left")) {
            ...
            x = canvasObj.width / 2 - currentLayer.width / 2;
        } else if (align.endsWith("right")) {
            x = canvasObj.width - currentLayer.width;
        }
        ...
        if (align.startsWith("middle")) {
            y = canvasObj.height / 2 - currentLayer.height / 2;
        }
        if (align.startsWith("bottom")) {
            y = canvasObj.height - currentLayer.height;
        }
